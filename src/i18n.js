  ...
  en: {
    ...
    charts: {
      growthTrend: {
        ...
        interactionHint: "Zoom with the toolbar or mouse wheel, then drag to pan.",
  ...
  "pt-BR": {
    ...
    charts: {
      growthTrend: {
        ...
        interactionHint: "Amplie com a barra ou com a roda do mouse e arraste para navegar.",
        downloadsLegend: "Downloads",
        completedLegend: "Escutas conclu\u00eddas",
        zoomIn: "Ampliar",
        zoomOut: "Reduzir",
        resetZoom: "Redefinir vista",
      },
      retentionScatter: {
